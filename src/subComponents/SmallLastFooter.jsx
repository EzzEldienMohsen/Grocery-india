...
const SmallLastFooter = () => {
  return (
    <div className="w-full  flex flex-col mt-4 mb-8 md:hidden ">
      ...
      <div className="mt-2 w-full flex flex-col justify-start items-start ">
        <img src={logo} alt="logo" className="w-40 mb-4 h-auto" />
        <div className="flex justify-between w-3/5 items-center">
          <FaInstagram className="w-10 h-10 mr-2" />
          <FaXTwitter className="w-10 h-10 mr-2" />
          <CiFacebook className="w-10 h-10 mr-2" />
          <FaLinkedin className="w-10 h-10 mr-2" />
        </div>
        <p className="mt-2 mb-8 opacity-65 text-black">
